          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="register-form" class="mb-3">
                ...
                <button class="btn btn-primary d-grid w-100">{{ __('button.signup') }}</button>
              </form>

              <p class="text-center">
                <span>{{ __('message.alreadyAccount') }}</span>
                <a href="{{ route('user.login') }}">
                  <span>{{ __('button.signin') }}</span>
                </a>
              </p>
            </div>
          </div>
        ...
        $("#register-form").validate({
            ...
            messages: {
                name: {
                    ...
                    maxlength: "{{ __('validation.max.string', ['attribute' => 'name', 'max' => 255]) }}"
                },
                email: {
